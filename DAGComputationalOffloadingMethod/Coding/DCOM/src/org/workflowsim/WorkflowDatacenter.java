...
public class WorkflowDatacenter extends Datacenter {
    ...
    protected void processCloudletSubmit(SimEvent ev, boolean ack) {
        ...
        try {
            ...
            if (estimatedFinishTime > 0.0 && !Double.isInfinite(estimatedFinishTime)) {
                Log.printLine("workflowDatacenter: cloudlet id #" + job.getCloudletId() + " is in execution queue => VM_DATACENTER_EVENT");
    ...
    protected void checkCloudletCompletion() {
                Log.printLine("datacenter checkCloudletCompletion");
        ...
        for (Host host : list) {
            for (Vm vm : host.getVmList()) {
                while (vm.getCloudletScheduler().isFinishedCloudlets()) {
                    ...
                    if (cl != null) {
                        Log.printLine("datacenter checkCloudletCompletion : CLOUDLET_RETURN");
